...
function Chatbot() {
  ...
  return (
    ...
    >
      ...
      <img src={icons} className="absolute bottom-70 left-20" />
        ...
        <div className="absolute bottom-30 right-30">
          ...
          >
            <img
              src={chatIcon}
              alt="Chat Icon"
              className="w-30 h-30 hover:filter hover:drop-shadow-[0_0_25px_#00FFC6]"
            />
          </button>
          ...
          <AnimatePresence>
            {showChatbot && (
              ...
              >
                <div className="absolute top-2 right-2 cursor-pointer" onClick={() => setShowChatbot(false)}>
                  <span className="text-white text-2xl">&times;</span>
                </div>
                <ChatBot
                  steps={steps}
                  className="p-4 bg-[#0A2A2E] rounded-lg shadow-inner"
                  style={{
